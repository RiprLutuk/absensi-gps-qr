    ...
    <form wire:submit="create">
      <x-slot name="content">
        ...
        <div class="mt-4">
          ...
          <x-tom-select id="form.division_id" wire:model="form.division_id" placeholder="{{ __('Select Division') }}"
        ...
        <div class="mt-4">
          ...
          <x-tom-select id="form.job_title_id" wire:model="form.job_title_id" placeholder="{{ __('Select Job Title') }}"
